...
public class GetApiTest  extends TestBase{
	...
	@Test(priority=1)
	public void getAPITestWithoutHeaders() throws ClientProtocolException, IOException, ParseException {
	...
	System.out.println("Respnse String is"+ responseString);
...
String perPageValue = TestUtil.getValueByJPath(responseJson, "/per_page");
	System.out.println("value of per is--->" + perPageValue);
...
System.out.println("Header Array--->"+allHeaders);
	...
	@Test(priority=2)
	public void getAPITestWithHeaders() throws ClientProtocolException, IOException, ParseException {
		restClient = new RestClient();
